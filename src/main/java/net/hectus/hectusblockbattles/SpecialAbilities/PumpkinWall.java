...
public class PumpkinWall {
    ...
    public int didPlayerContinuePlacing(int x, int y, int z, Material blockType, boolean facingCenter, int direction, boolean placedBlockingTheSun) { //direction 0: wall facing positive x; 1: facing negative x; 2: facing pos z; 3: neg z;
