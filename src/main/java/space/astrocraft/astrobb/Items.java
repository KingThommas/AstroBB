...
import static space.astrocraft.astrobb.InGameShop.HotBar.*;
import static space.astrocraft.astrobb.Items.Quality.*;
import static space.astrocraft.astrobb.Items.Rarity.*;
import static space.astrocraft.astrobb.Items.Type.*;
...
public enum Items {
    ...
    SPRUCE_TRAPDOOR(NORMAL, COUNTER, COMMON, DECENT, false, 4, List.of(WarpSettings.Class.NEUTRAL, WarpSettings.Class.WATER, WarpSettings.Class.NATURE)),
    IRON_TRAPDOOR(OVERTIME, COUNTER, UNCOMMON, DECENT, false, 5, List.of(WarpSettings.Class.NEUTRAL, WarpSettings.Class.WATER, WarpSettings.Class.REDSTONE)),
    ...
    CYAN_CARPET(COUNTER, RARE, DECENT, false, 7, List.of(WarpSettings.Class.REDSTONE, WarpSettings.Class.DREAM), Buff.extraTurn()),
    ENDER_PEARL(NORMAL, COUNTER, UNCOMMON, DECENT, true, 10, null, Buff.extraTurn()),
    CHORUS_FRUIT(OVERTIME, COUNTER, RARE, BAD, true, 8, null),
    IRON_SHOVEL(COUNTER, RARE, BAD, true, 5, List.of(WarpSettings.Class.HOT), Buff.extraTurn()),
    STONECUTTER(COUNTER, EPIC, DECENT, false, 7, null, Buff.extraTurn()),
    MAGENTA_GLAZED_TERRACOTTA(COUNTERATTACK, RARE, BAD, false, 6, List.of(WarpSettings.Class.NEUTRAL, WarpSettings.Class.HOT, WarpSettings.Class.COLD, WarpSettings.Class.WATER, WarpSettings.Class.NATURE)),
    SPONGE(COUNTERATTACK, RARE, GOOD, false, 8, List.of(WarpSettings.Class.NEUTRAL, WarpSettings.Class.WATER, WarpSettings.Class.DREAM), new Buff("rain", "0", false), Buff.extraTurn(), Buff.luck(5, false), new Buff("sponge.bucket_jump_boost", "10", false)),
    // ============ HOT ITEMS ============
    MAGMA_BLOCK(ATTACK, UNCOMMON, DECENT, false, 5, null),
    NETHERRACK(COUNTERATTACK, UNCOMMON, BAD, false, 4, List.of(WarpSettings.Class.HOT, WarpSettings.Class.COLD, WarpSettings.Class.WATER)),
    LAVA_BUCKET(BUFF, RARE, GOOD, true, 10, null, new Buff("burns", "0", true)),
    FLINT_AND_STEEL(COUNTER, EPIC, BAD, false, 4, List.of(WarpSettings.Class.COLD, WarpSettings.Class.REDSTONE, WarpSettings.Class.NATURE), new Buff("blindness", "0", false), new Buff("blindness", "0", true), new Buff("glowing", "0", false), new Buff("glowing", "0", true)),
    ORANGE_WOOL(COUNTER, UNCOMMON, BAD, false, 5, List.of(WarpSettings.Class.REDSTONE, WarpSettings.Class.DREAM)),
    CAMPFIRE(COUNTERATTACK, COMMON, DECENT, false, 6, List.of(WarpSettings.Class.NEUTRAL, WarpSettings.Class.HOT, WarpSettings.Class.COLD), Buff.extraTurn(), Buff.luck(10, false)),
    ...
    BLUE_ICE(COUNTER, UNCOMMON, BAD, false, 4, List.of(WarpSettings.Class.COLD, WarpSettings.Class.WATER, WarpSettings.Class.DREAM)),
    SPRUCE_LEAVES(COUNTERATTACK, UNCOMMON, BAD, false, 3, List.of(WarpSettings.Class.NEUTRAL, WarpSettings.Class.NATURE)),
    LIGHT_BLUE_WOOL(ATTACK, COMMON, BAD, false, 4, null),
    WHITE_WOOL(COUNTER, COMMON, DECENT, false, 7, List.of(WarpSettings.Class.NEUTRAL, WarpSettings.Class.WATER, WarpSettings.Class.REDSTONE, WarpSettings.Class.DREAM), new Buff("slowness", "255", false), new Buff("slowness", "255", true)),
    POWDER_SNOW(SPECIAL, RARE, GOOD, false, 8, null, new Buff("freezes", "0", true)),
    SNOWBALL(SPECIAL, EPIC, GOOD, false, 7, List.of(WarpSettings.Class.HOT), Buff.extraTurn(), Buff.luck(15, false), new Buff("glowing", "0", true)),
    POLAR_BEAR_SPAWN_EGG(BUFF, EPIC, GOOD, false, 8, null, new Buff("speed", "3", true), new Buff("no_jump", "0", true)),
    // =========== WATER ITEMS ===========
    BRAIN_CORAL_BLOCK(COUNTERATTACK, RARE, POOR, false, 4, List.of(WarpSettings.Class.REDSTONE)),
    HORN_CORAL(COUNTERATTACK, COMMON, BAD, false, 5, List.of(WarpSettings.Class.NEUTRAL, WarpSettings.Class.NATURE, WarpSettings.Class.WATER)),
    FIRE_CORAL(COUNTERATTACK, UNCOMMON, BAD, false, 5, List.of(WarpSettings.Class.HOT, WarpSettings.Class.REDSTONE)),
    FIRE_CORAL_FAN(COUNTER, UNCOMMON, DECENT, false, 6, List.of(WarpSettings.Class.HOT, WarpSettings.Class.REDSTONE), new Buff("extra_turn", "80% Chance", false)),
    ...
    VERDANT_FROGLIGHT(COUNTERATTACK, UNCOMMON, POOR, false, 5, List.of(WarpSettings.Class.DREAM)),
