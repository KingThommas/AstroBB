...
public class BaseEvents implements Listener {
    ...
    public void onPotionSplash(@NotNull PotionSplashEvent event) {
        ...
        Player p = (Player) Objects.requireNonNull(event.getPotion().getShooter());
    ...
    public void onBlockPlace(@NotNull BlockPlaceEvent event) {
        ...
        switch (b.getType()) {
            ...
            case WATER -> {
                ...
                if (!c.toLocation().getNearbyEntitiesByType(PufferFish.class, 4).isEmpty()) {
        ...
        switch (event.getCause()) {
            ...
            case CHORUS_FRUIT -> {
                if (outOfBounds(event.getTo())) {
                    ...
                    p.teleport(new Location(AstroBB.WORLD, x, p.getLocation().y(), z));
                } else {
                    turn(Turn.ENDER_PEARL_TP, p, Cord.of(event.getTo()));
                }
